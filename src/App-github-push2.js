...
// ─── Settings Modal ───────────────────────────────────────────────────────────
function SettingsModal({ onClose, activeProperty, onOpenStaffManagement, onOpenAddProperty, showAddProperty, onOpenManageProperties }) {
  return (
...
function ManagePropertiesModal({ onClose, userId, properties, activeProperty, onDeleted, onUpdated }) {
